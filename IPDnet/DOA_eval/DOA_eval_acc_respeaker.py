...
def evaluate_one_file_with_csv(
    ...
    pred_doas = postprocess_one_sample(
        ...
        min_points_per_source=min_points_per_source,
        plot=True,
        gt_doas=gt_doas,
    )
...
scene_index=2
min_points_per_source=1

result = evaluate_one_file_with_csv(
        doaest_path=fr"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet\inference_results_respeaker\{scene_index}_doaest.npy",
        vadest_path=fr"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet\inference_results_respeaker\{scene_index}_vadest.npy",
        csv_path=r"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet\inference_results_respeaker\ground_truth.csv",
...
#         vadest_path=fr"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet2\inference_results\{scene_index}_vadest.npy",
#         csv_path=r"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet2\inference_results\ground_truth.csv",
#         scene_index=scene_index,
#         sample_idx=0,
#         num_sources=3,
#         vad_th=0.2,
