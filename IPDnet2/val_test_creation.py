...
if __name__ == "__main__":
    # # Validation set
    # generate_fixed_set(
    #     save_dir=r"E:/RealMAN/val_gen",
    #     data_dir=r"E:/RealMAN/",
    #     target_csvs=[
    #         r"E:/RealMAN/val/val_static_source_location.csv",
    #         r"E:/RealMAN/val/val_moving_source_location.csv",
    #     ],
    #     noise_dir=r"E:/RealMAN/val/ma_noisy_speech",
    #     use_mic_id=[1, 3, 5, 7, 0],
    #     max_source=2,
    # )
