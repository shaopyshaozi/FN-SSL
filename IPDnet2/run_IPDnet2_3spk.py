...
import Module_3spk as at_module
...
from Inference_Data import InferenceDataset
...
class MyModel(LightningModule):
    ...
    def predict_step(self, batch, batch_idx: int):
        ...
        data_batch = self.data_preprocess_inference(
        ...
        # manually inject fixed mic geometry here
        use_mic_id = [2, 4, 6, 8]
    ...
    def data_preprocess_inference(self, mic_sig_batch=None, eps=1e-6):
        ...
        real_image_batch = torch.cat(
            (stft_rebatch_real, stft_rebatch_image),
            dim=1
        )
